...
import cl.uach.inf.sophia.datacollection.twitter.CollectArticlesFromAPIToSophia;
...
public class SophiaCollector {
	...
	public static void main(String[] args) throws OAuthMessageSignerException, OAuthExpectationFailedException, OAuthCommunicationException {
		...
		//t2.start();
		CollectArticlesFromAPIToSophia t3 = new CollectArticlesFromAPIToSophia("CollectArticlesFromAPIToSophia-1");
		t3.start();
	}
}
